### Log into workstation, run powershell commands to install an agent onto the machine to capture the machine ID for the deployment. Create a folder to put the ID name in it. 
